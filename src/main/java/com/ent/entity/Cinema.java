...
public class Cinema {
	...
	public enum CinemaPlatform {
		NETFLIX, PRIME, HOTSTAR, HOICHOI, ADDATIMES, THREATER, VOD, ZEE5, SONYLIV, HBOMAX, VOOT, EROSNOW, APPLETV, YOUTUBE, ALTBALAJI, DICCOVERYPLUS, MXPLAYER, AHA, LIONSGATEPLAY;
	}
